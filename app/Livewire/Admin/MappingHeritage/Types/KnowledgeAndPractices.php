...
class KnowledgeAndPractices extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        IntangibleCulturalHeritage::create([
            'cultural_heritage_category' => 'IntangibleCulturalHeritage',
            'cultural_heritage_type' => 'Knowledge and Practices',
            'name' => $this->name,
    ...
    {
        return view('livewire.admin.mapping-heritage.types.knowledge-and-practices');
    }
}
