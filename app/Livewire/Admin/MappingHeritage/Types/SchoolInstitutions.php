...
class SchoolInstitutions extends Component
{
    ...
    public function save()
    {
        ...
        CulturalInstitutions::create([
            ...
            'cultural_heritage_type' => 'School Institutions',
            'name' => $this->name,
    ...
    {
        return view('livewire.admin.mapping-heritage.types.school-institutions');
    }
}
