...
<x-slot:secHeading>Restoration in-Progress</x-slot:secHeading>
<x-admin.body>
    <div class="w-full flex flex-wrap px-2 py-4 gap-2">
        ...
        <button class="bg-clr-crimson rounded p-2 text-white insert-placeholder" data-placeholder="status">Add Status field</button>
        ...
        <button class="bg-clr-crimson rounded p-2 text-white insert-placeholder" data-placeholder="images">Add Image attachments</button>
        <button class="bg-clr-crimson rounded p-2 text-white insert-placeholder" data-placeholder="remarks">Add Remarks field</button>
