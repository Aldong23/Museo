...
<x-slot:secHeading>Adding of User</x-slot:secHeading>
<x-admin.body>
    <div class="flex w-full gap-2 mb-4">
        ...
        <div class="w-full">
            <x-form.select-input label="" wire:model="position">
    ...
    {{-- <div class="flex items-center gap-2">
        ...
        <button class="px-4 py-2 border border-gray-600 rounded-md font-bold mt-7">Generate</button>
    </div> --}}
