                ...
                <x-form.table.table class="border-none">
                    ...
                    @foreach ($items as $item)
                        <x-form.table.tr>
                            <x-form.table.td>
                                <a class="block"
                                    href="{{ route('government.details', $item->id) }}">{{ $item->name }}</a>
                            </x-form.table.td>
                        </x-form.table.tr>
                    @endforeach
                </x-form.table.table>
            ...
            @if ($type === 'Sites')
                <x-form.table.table class="border-none">
                    ...
                    @foreach ($items as $item)
                        <x-form.table.tr>
                            <x-form.table.td>
                                <a class="block" href="{{ route('sites.details', $item->id) }}">{{ $item->name }}</a>
                            </x-form.table.td>
                        </x-form.table.tr>
                    @endforeach
                </x-form.table.table>
            ...
            @if ($type === 'House')
                <x-form.table.table class="border-none">
                    ...
                    @foreach ($items as $item)
                        <x-form.table.tr>
                            <x-form.table.td>
                                <a class="block" href="{{ route('house.details', $item->id) }}">{{ $item->name }}</a>
                            </x-form.table.td>
                        </x-form.table.tr>
                    @endforeach
                </x-form.table.table>
