<div class="w-full h-full flex flex-col pb-8">
    ...
    <x-form.input label="Name of Natural Heritage" wire:model="name" />
    @error('name')
    ...
    <div class="w-full flex items-center gap-2">
        ...
        <div class="w-full">
            <div wire:ignore class="w-full">
                <x-form.select2 label="" id="sub_category" wire:model="sub_category">
                    <option value="">Sub-Category</option>
                    <option value="Sea">Sea</option>
                    <option value="River / Riverbank">River / Riverbank</option>
    ...
    <x-form.input label="Ownership / Jurisdiction" wire:model="ownership" />
    @error('ownership')
        <x-form.error> {{ $message }} </x-form.error>
    @enderror
