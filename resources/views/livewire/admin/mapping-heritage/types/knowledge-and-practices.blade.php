    ...
    <div class="w-full">
        <div wire:ignore class="w-full">
            <x-form.select2 label="Type" id="type" wire:model="type">
                ...
                <option value="Traditional ecological wisdom">Traditional ecological wisdom</option>
                <option value="Indigenous knowledge">Indigenous knowledge</option>
                <option value="Knowledge about local flora and fauna">Knowledge about local flora and fauna</option>
                <option value="Subsistence technology (farming)">Subsistence technology (farming)</option>
                <option value="Subsistence technology (fishing)">Subsistence technology (fishing)</option>
                <option value="Subsistence technology (hunting)">Subsistence technology (hunting)</option>
                <option value="Subsistence technology (food)">Subsistence technology (food)</option>
                <option value="Subsistence technology (preservation)">Subsistence technology (preservation)</option>
                <option value="Subsistence technology (gathering)">Subsistence technology (gathering)</option>

                <option value="Traditional healing systems, rituals, beliefs">Traditional healing systems, rituals,
                    beliefs</option>
                <option value="Initiatory rites">Initiatory rites</option>
                <option value="Possession rites">Possession rites</option>
