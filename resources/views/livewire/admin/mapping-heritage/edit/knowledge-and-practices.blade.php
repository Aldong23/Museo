...
<x-admin.body>
    <div class="w-full h-full flex flex-col pb-8">
        ...
        <div class="w-full">
            <div wire:ignore class="w-full">
                <x-form.select2 label="Type" id="type" wire:model="type">
                    ...
                    <option value="Traditional Governance / Justice System">Traditional Governance / Justice System
                    </option>
                    <option value="Settlement Patterns">Settlement Patterns</option>
                    <option value="Cuisine / Culinary Traditions">Cuisine / Culinary Traditions</option>
                    <option value="Worship Rites">Worship Rites</option>
                    <option value="Rites of Passage">Rites of Passage</option>
                    <option value="Birth, Wedding, Funeral Rituals">Birth, Wedding, Funeral Rituals</option>
                    <option value="Fiesta / Festival">Fiesta / Festival</option>
                    <option value="Kinship Ceremonies">Kinship Ceremonies</option>
                </x-form.select2>
        ...
        <x-form.select-input label="Related Domains of the Intangible Cultural Heritage" wire:model="related_domains">
            ...
            <option value="Knowledge and practices concerning nature and the universe">Knowledge and practices
                concerning
        ...
        <div class="w-full h-auto p-2 mt-4 mb-4">
            <h1 class="text-gray-800 mb-1">List of Significant Tangible Movable Heritage Used / Associated with the
                Element
            </h1>
            <x-form.table.table>
                <x-slot:head>
                        ...
                        <x-form.table.td class="align-middle">
                            ...
                            <div class="w-full flex gap-1 items-center">
                                ...
                                @if (!empty($list['photo_1']))
                                    <div class="w-fit">
                                        @if ($list['photo_1'] instanceof \Illuminate\Http\UploadedFile)
                                            <img class="rounded-sm h-11 flex"
                                                src="{{ $list['photo_1']->temporaryUrl() }}">
                                        @else
                                            <img class="rounded-sm h-11 flex"
                                                src="{{ Storage::url($list['photo_1']) }}">
                                        @endif
                                    </div>
                                @endif
                            </div>
                        ...
                        <x-form.table.td class="align-middle">
                            <div class="w-full flex gap-1 items-center">
                                ...
                                @if (!empty($list['photo_2']))
                                    <div class="w-fit">
                                        @if ($list['photo_2'] instanceof \Illuminate\Http\UploadedFile)
                                            <img class="rounded-sm h-11 flex"
                                                src="{{ $list['photo_2']->temporaryUrl() }}">
                                        @else
                                            <img class="rounded-sm h-11 flex"
                                                src="{{ Storage::url($list['photo_2']) }}">
                                        @endif
                                    </div>
                                @endif
                            </div>
        ...
        <x-form.select-input label="Measures and Description of Safeguard Measure Taken"
            ...
            <option value="">Select</option>
            <option value="Transmission, particularly through formal education">Transmission, particularly through
                formal
                education</option>
        ...
        @if ($attachment_image)
            @if ($attachment_image instanceof \Illuminate\Http\UploadedFile)
            ...
            @else
                <div class="w-fit flex flex-col items-end gap-2 p-2 border border-gray-400 rounded-lg ">
                    <img class="rounded-md h-64 flex" src="{{ Storage::url($attachment_image) }}">
                    <button class="w-fit text-white text-xs bg-red-500 rounded py-1 px-2"
                        wire:click="change2">Remove</button>
                </div>
            @endif
