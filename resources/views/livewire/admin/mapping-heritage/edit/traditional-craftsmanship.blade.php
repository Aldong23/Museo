        ...
        <div class="w-full">
            <div wire:ignore class="w-full">
                <x-form.select2 label="Type" id="type" wire:model="type">
                    ...
                    <option value="Textile-making/Weaving">Textile-making/Weaving</option>
                    <option value="Embroidery">Embroidery</option>
                    <option value="Jewelry/adornment-making">Jewelry/adornment-making</option>
                    <option value="Print-making">Print-making</option>
                    <option value="Boat-making">Boat-making</option>
                    <option value="Metallurgy / Smiting">Metallurgy / Smiting</option>
                    ...
                    <option value="Shelter-making">Shelter-making</option>
                </x-form.select2>
