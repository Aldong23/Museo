...
<x-admin.body>
    <div class="w-full h-full flex flex-col pb-8">
            ...
            <div class="w-full">
                <div wire:ignore class="w-full">
                    <x-form.select2 label="Classification" id="classification" wire:model="classification">
                        ...
                        <option
                            value="Marine / Freshwater Organisms (Molluscs, Crutaceans, Echinoderms, Coelenterates)">
        ...
        <x-form.textarea label="Habitat" wire:model="habitat" />
        @error('habitat')
            <x-form.error> {{ $message }} </x-form.error>
        @enderror
        ...
        <div class="w-full flex items-center">
            ...
            <div class="w-full">
                <div wire:ignore class="w-full">
                    <x-form.select2 label="" id="visibility" wire:model="visibility">
                        <option value="">Select</option>
        ...
        @script()
            <script>
                $(document).ready(function() {
                    ...
                    $('#visibility').select2({
                        placeholder: 'Indicate Visibility',
                        tags: true
                    });
