...
<x-admin.body>
    <div class="w-full h-full flex flex-col pb-8">
        ...
        <div class="w-full flex items-center gap-2">
            ...
            <div class="w-full">
                <div wire:ignore class="w-full">
                    <x-form.select2 label="Period" id="type" wire:model="type">
                        <option value="">Select</option>
                        <option value="Indigenous">Indigenous</option>
                        <option value="Spanish Period">Spanish Period</option>
                        <option value="American Period">American Period</option>
                        <option value="World War II Period">World War II Period</option>
        ...
        <div class="w-full flex items-center gap-2">
            ...
            <div class="w-full">
                <x-form.input label="Year Constructed" wire:model="year_constructed"
        ...
        <div class="w-100">
            ...
            <x-form.input label="" wire:model="condition_of_structure" />
            @error('condition_of_structure')
                <x-form.error> {{ $message }} </x-form.error>
            @enderror --}}

            <h1 class="font-bold text-xl">Conservation</h1>
            <x-form.textarea label="" wire:model="condition_of_structure" />
            @error('condition_of_structure')
                <x-form.error> {{ $message }} </x-form.error>
            @enderror

            {{-- saved to condition of structure column --}}
        </div>
