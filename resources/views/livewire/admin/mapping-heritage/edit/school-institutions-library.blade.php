...
<x-admin.body>
    <div class="w-full h-full flex flex-col pb-8">
        ...
        {{-- ===================================================== Remarks  --}}
        <div class="w-full p-2">
            <h1 class="text-gray-900 my-2">Narative Description</h1>

            @if ($organizational_chart)
                <x-form.file-input-wrapper multiple accept="image/*" name="organizational_chart"
                    wire:model="organizational_chart">
                    @foreach ($organizational_chart as $key => $collection)
                        <div class="relative">
            ...
            @else
                <x-form.file multiple accept="image/*" name="organizational_chart"
                    wire:model="organizational_chart" />
            @endif
        </div>
