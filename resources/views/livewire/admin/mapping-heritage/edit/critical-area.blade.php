...
<x-admin.body>
    <div class="w-full h-full flex flex-col pb-8">
        ...
        <x-form.input label="Name of Area" wire:model="name" />
        @error('name')
        ...
        <div class="w-full flex items-center gap-2">
            <div class="w-full">
                <x-form.select-input label="" wire:model="location">
            ...
            <div class="w-full">
                <x-form.input label="" placeholder="Address (Optional)" wire:model="address" />
                @error('address')
                    <x-form.error> {{ $message }} </x-form.error>
                @enderror
            </div>
        ...
        <x-form.input label="Existing Hazard Type" wire:model="hazard" />
        @error('hazard')
            <x-form.error> {{ $message }} </x-form.error>
        @enderror
        ...
        {{-- <div class="w-full flex items-center gap-2">
            <div class="w-full">
                <x-form.input label="Photo Credit" wire:model="photo_credit" />
                @error('photo_credit')
                    <x-form.error> {{ $message }} </x-form.error>
                @enderror
            </div>
            <div class="w-full">
                <x-form.date-input label="Photo Date Captured" wire:model="photo_date" />
                @error('photo_date')
                    <x-form.error> {{ $message }} </x-form.error>
                @enderror
            </div>
        ...
        <x-form.textarea label="Summary" wire:model="summary" />
        @error('summary')
            <x-form.error> {{ $message }} </x-form.error>
        @enderror
