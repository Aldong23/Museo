...
<x-admin.body>
    <div class="w-full h-full flex flex-col pb-8">
            ...
            <div class="w-full">
                <div wire:ignore class="w-full">
                    <x-form.select2 label="Type" id="type" wire:model="type">
                        ...
                        <option value="Municipal / City Hall">Municipal / City Hall</option>
                        <option value="Barangay Hall">Barangay Hall</option>
                        <option value="Government Agency Bldg">Government Agency Bldg</option>
                        ...
                        <option value="Ice Plant">Ice Plant</option>
                        <option value="Dam/ Dike">Dam/ Dike</option>
        ...
        <div class="w-full flex items-center gap-2">
            ...
            <div class="w-full">
                <x-form.input label="" placeholder="Longitude" wire:model="longitude" />
                @error('longitude')
                    <x-form.error> {{ $message }} </x-form.error>
                @enderror
            </div>
            ...
            <div class="w-full">
                <x-form.input label="Year Constructed (e.g., 1990 / 2000)" wire:model="year_constructed" />
        ...
        <div class="w-full flex items-center gap-2">
            <div class="w-full">
                <x-form.input label="Total Land Area" wire:model="area" />
                @error('area')
                    <x-form.error> {{ $message }} </x-form.error>
                @enderror
            </div>
        ...
        <x-form.textarea label="Stories Associated with the Structure" wire:model="stories" />
        @error('stories')
            <x-form.error> {{ $message }} </x-form.error>
        @enderror
        ...
        <div class="w-96">
            ...
            <x-form.select-input label="Condition of Structure" wire:model="condition_of_structure">
                <option value="">Select</option>
        ...
        <div class="w-96">
            ...
            <x-form.select-input label="Integrity of the Structure" wire:model="integrity_of_structure">
                <option value="">Select</option>
                    ...
                    <x-form.table.tr>
                        ...
                        <x-form.table.td class="align-middle">
                            <div class="w-full flex gap-1 items-center">
                                ...
                                @if (!empty($list['photo']))
                                    <div class="w-fit">
                                        @if ($list['photo'] instanceof \Illuminate\Http\UploadedFile)
                                            <img class="rounded-sm h-11 flex"
                                                src="{{ $list['photo']->temporaryUrl() }}">
                                        @else
                                            <img class="rounded-sm h-11 flex"
                                                src="{{ Storage::url($list['photo']) }}">
                                        @endif
                                    </div>
                                @endif
                            </div>
