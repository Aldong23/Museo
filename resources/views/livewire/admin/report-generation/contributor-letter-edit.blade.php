...
<x-admin.body>
    <div class="w-full flex flex-wrap px-2 py-4 gap-2">
        <button class="bg-clr-crimson rounded p-2 text-white insert-placeholder" data-placeholder="contributor">Add Contributor field</button>
    ...
    <div class="flex items-center justify-end px-4 py-6">
        <div class="flex items-center gap-4">
            <x-form.cancel-link href="/contributor-report">Cancel</x-form.cancel-link>
